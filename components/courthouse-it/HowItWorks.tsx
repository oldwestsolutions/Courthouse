...
import { itHowItWorksContent, itProcessSteps } from "@/lib/courthouse-it-data";
    ...
    >
      <div className="ch-shell py-[100px]">
        <div className="mx-auto max-w-[640px] text-center">
          ...
          >
            {itHowItWorksContent.subheading}
          </motion.p>
        </div>
        <motion.div
          ...
          {itProcessSteps.map((step) => (
            ...
            >
              ...
              <div className="relative">
                <h3 className="font-display" style={{ fontSize: 22, color: "var(--ch-ivory)" }}>
                  {step.name}
                </h3>
                <div
                  className="my-5 h-px"
                  style={{ width: 40, backgroundColor: "rgba(184, 153, 106, 0.35)" }}
                />
                <p
                  className="text-[15px]"
